...
public class GS 
{
    ...
    public static void IniciarSesion()
    {
        ...
        for(int i = 0; i < TotalUsuarios.size(); i++)
        {
            if (ValidacionUser(user, TotalUsuarios.get(i).getNombre()))
            {
                //Verificacion de contraseña
                System.out.println("Ingrese su contraseña");
                if(ValidacionContraseña(entrada.nextLine(), TotalUsuarios.get(0).getContraseña()))
                {
                    switch(String.valueOf(TotalUsuarios.get(i).getTipoUsuario().charAt(0)))
                    {
                        case "A":
                            //Acciones que puede realizar el Administrador
                        ...
                        case "M":
                            //Ejecucion de lo que puede hacer el mesero
    ...
    public static void main (String[]args)
    {
        ...
        TotalUsuarios.add(new Usuarios("A01", "Jhosep", "123", "72394996", "986644487", 20));
        TotalUsuarios.add(new Usuarios("M01", "Marco", "123", "12345678", "981314871", 20));
        //TotalUsuarios.add(new Usuarios("A01", "Marco", "123", "72394996", "986644487", 20));
        //TotalUsuarios.add(new Usuarios("A01", "Marco", "123", "72394996", "986644487", 20));
